...
$B['APP_HOST'] = "darklabs.tk";                 //edit to your domain, example (WARNING - without http:// and www): yourdomain.com
$B['APP_URL'] = "http://darklabs.tk";           //edit to your domain url, example (WARNING - with http://): http://yourdomain.com
...
$B['GOOGLE_API_KEY'] = "AIzaSyAiWi58csMVXNy5qHC5i91Kc5N1HLpwY0E";
$B['GOOGLE_SENDER_ID'] = "782397443447";
...
$B['SMTP_HOST'] = 'marketplace.site.com';                   //SMTP host | Specify main and backup SMTP servers
...
$C['DB_HOST'] = "mysql.hostinger.ru";                                //localhost or your db host
$C['DB_USER'] = "u912027439_dl";                             //your db user
$C['DB_PASS'] = "retro1970";                         //your db password
$C['DB_NAME'] = "u912027439_dl";                             //your db name
